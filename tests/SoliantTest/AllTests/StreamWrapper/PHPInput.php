...
namespace SoliantTest\AllTests\StreamWrapper;
 ...
 *     {
 *         Soliant\AllTests\StreamWrapper\PHPInput::mockInput('expected string');
 *     }
 *
 *     public function testReadingFromPhpInput()
 *     {
 *         $this->assertSame('expected string', file_get_contents('php://input'));
 *         $this->assertSame('php://input', Soliant\AllTests\StreamWrapper\PHPInput::getCurrentPath());
 *     }
 *
...
class PHPInput
{
    ...
    public static function mockInput($data)
    {
        ...
        stream_wrapper_register('php', 'SoliantTest\\AllTests\\StreamWrapper\\PHPInput');
        self::$_data = $data;
    }
